...
template <>
void Button<sf::CircleShape>::reset()
    { m_clicked = false; }
template <>
std::size_t Button<sf::CircleShape>::getPointCount() const
    { return m_shape.getPointCount(); }
template <>
sf::Vector2f Button<sf::CircleShape>::getPoint(std::size_t index) const
